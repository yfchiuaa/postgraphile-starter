...
function makeExtendSchemaPlugin(generator, uniqueId = String(Math.random()).substr(2)) {
    ...
    return (builder, schemaOptions) => {
        ...
        builder.hook("build", build => {
            ...
            const { addType } = build;
            const { GraphQLEnumType, GraphQLInputObjectType, GraphQLObjectType, GraphQLScalarType, GraphQLDirective, GraphQLUnionType, } = graphql;
        ...
        builder.hook("init", (_, build, _context) => {
            ...
            [`ExtendSchemaPlugin_${uniqueId}_newTypes`]: newTypes, [`ExtendSchemaPlugin_${uniqueId}_resolvers`]: resolvers, graphql: { GraphQLEnumType, GraphQLObjectType, GraphQLInputObjectType, GraphQLUnionType, GraphQLScalarType, GraphQLDirective, Kind, }, } = build;
